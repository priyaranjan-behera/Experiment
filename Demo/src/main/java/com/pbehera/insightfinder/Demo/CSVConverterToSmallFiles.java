...
public class CSVConverterToSmallFiles {
	...
	public static String[] destinationCSVFile = {"/home/pbehera/output_small1.csv","/home/pbehera/output_small2.csv","/home/pbehera/output_small3.csv","/home/pbehera/output_small4.csv","/home/pbehera/output_small5.csv"};
	...
	static void generateOutputCSVFiles(String sourceCSVFile, String sourceCSVFile2, Date startTime, Date endTime, String[] destinationCSVFile) throws ParseException, IOException
	{
		...
		int instanceInFile = topInstances.size()/5;
		
		for(int j=1; j<=5; j++)
		{
			FileWriter fileWriter = new FileWriter(destinationCSVFile[j-1]);
			
			fileWriter.append("timestamp");
			
			int counter = 0;
			
			for(int k=(j-1)*instanceInFile; k<j*instanceInFile; k++)
			{
	...
	public static void main(String[] args) throws ParseException, IOException {
		...
		generateOutputCSVFiles(sourceCSVFile, sourceCSVFile2, startTime, endTime, destinationCSVFile);
